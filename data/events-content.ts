    ...
    items: [
      {
        type: 'Conversatorios',
        description:
          'Diálogos abiertos sobre temas de actualidad en psicoterapias asistidas',
        icon: Users,
      },
      {
        type: 'Talleres Prácticos',
        description:
          'Capacitación interactiva con ejercicios y herramientas aplicables',
        icon: Clock,
      },
      {
        type: 'Seminarios Especializados',
        description:
          'Profundización en temas específicos con expertos reconocidos',
        icon: Calendar,
      },
      {
        type: 'Conferencias Magistrales',
        description:
          'Presentaciones de investigación de punta y hallazgos científicos',
        icon: Ticket,
      },
    ],
  },
  ...
  upcomingEvents: {
    ...
    events: [
      ...
      },
      {
        id: 2,
        title:
          'Taller de Formación: Preparación Psicológica en Terapias Psicodélicas',
        date: '2025-09-20',
        time: '14:00 - 18:00',
        ...
        ticketPrice:
          'Socios: Gratuito | No socios: $1200 | Estudiantes: $600',
      },
      {
        id: 3,
      ...
      },
      {
        id: 4,
        title:
          'Conferencia: Investigación Reciente en Depresión Resistente al Tratamiento',
        date: '2025-11-08',
        time: '18:00 - 20:00',
